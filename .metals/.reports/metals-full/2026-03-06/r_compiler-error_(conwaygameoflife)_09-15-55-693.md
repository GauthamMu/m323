...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_element)
       tree position: line 42 of file://<WORKSPACE>/conwaygameoflife/src/main/scala/conwaygameoflife/ConwayGameOfLife.scala
            tree tpe: <error>
              symbol: value <error: <none>>
   symbol definition: val <error: <none>>: <error> (a TermSymbol)
      symbol package: conwaygameoflife
       symbol owners: value <error: <none>> -> value <local ConwayGameOfLife> -> object ConwayGameOfLife
           call site: <none> in <none>

== Source file context for tree position ==

    39 
    40 		def setCounter(count: Int): Unit =
    41 			counter = count
    42 			_CURSOR_element.innerHTML = s"count is $counter"
    43 
    44 		element.addEventListener("click", e => setCounter(counter + 1))
    45 		setCounter(0)
