...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Literal(Constant(1))
       tree position: line 46 of file://<WORKSPACE>/conwaygameoflife/src/main/scala/conwaygameoflife/ConwayGameOfLife.scala
            tree tpe: Int(1)
              symbol: null
...
== Source file context for tree position ==
    ...
    43 			counter = count
    44 			element.innerHTML = s"count is $counter"
    45 
    46 		_CURSOR_element.addEventListener("click", e => setCounter(counter + 1))
    47 		setCounter(0)
    48 	end setupCounter
    49 
