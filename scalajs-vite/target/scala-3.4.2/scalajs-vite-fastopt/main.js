...
/** @constructor */
function $c_Lapp_Main$package$() {
}
$c_Lapp_Main$package$.prototype = new $h_O();
$c_Lapp_Main$package$.prototype.constructor = $c_Lapp_Main$package$;
/** @constructor */
function $h_Lapp_Main$package$() {
}
$h_Lapp_Main$package$.prototype = $c_Lapp_Main$package$.prototype;
$c_Lapp_Main$package$.prototype.Main__V = (function() {
  var count = new $c_sr_IntRef(0);
  var heading = document.createElement("h1");
  heading.textContent = "Hello from Scala.js! \ud83c\udf89";
  var counter = document.createElement("p");
  counter.textContent = ("Count: " + count.sr_IntRef__f_elem);
  var button = document.createElement("button");
  button.textContent = "Click me";
  button.addEventListener("click", ((_$1) => {
    count.sr_IntRef__f_elem = ((1 + count.sr_IntRef__f_elem) | 0);
    counter.textContent = ("Count: " + count.sr_IntRef__f_elem);
  }));
  ...
  button.addEventListener("click", ((_$2) => {
    var dimensions = new $ac_I(new Int32Array([60, 60]));
    ...
    while (true) {
      ...
      while (true) {
        var arg1$3 = i$3;
        var row = table.rows[arg1$2];
        var cell = row.cells[arg1$3];
        var checkbox$1 = cell.firstChild;
        $n($n(currentState).get(arg1$2)).set(arg1$3, $uZ(checkbox$1.checked));
        if ((i$3 === 59)) {
          break;
        }
        i$3 = ((1 + i$3) | 0);
    ...
    var dimensions$1 = new $ac_I(new Int32Array([60, 60]));
    var nextState = $asArrayOf_Z($m_jl_reflect_Array$().newInstance__jl_Class__AI__O($d_Z.getClassOf(), dimensions$1), 2);
    var i$4 = 0;
    while (true) {
      var arg1$4 = i$4;
      var i$5 = 0;
      while (true) {
        ...
        while ($n(it$2).hasNext__Z()) {
          ...
          matchResult2: {
            var $x_1;
            if ((x$1$2 !== null)) {
              var dr$1 = $uI($n(x$1$2).T2__f__1);
              var dc$1 = $uI($n(x$1$2).T2__f__2);
              var nr = ((arg1$4 + dr$1) | 0);
              var nc = ((arg1$5 + dc$1) | 0);
              var $x_1 = (((((nr >= 0) && (nr < 60)) && (nc >= 0)) && (nc < 60)) && $n($n(currentState).get(nr)).get(nc));
              break matchResult2;
            }
        ...
        var liveNeighbors = res;
        var $x_3 = $n($n(nextState).get(arg1$4));
        matchResult3: {
          var $x_2;
          var x7 = $n($n(currentState).get(arg1$4)).get(arg1$5);
          if ((x7 === true)) {
            var $x_2 = ((liveNeighbors === 2) || (liveNeighbors === 3));
            break matchResult3;
          }
          if ((x7 === false)) {
            var $x_2 = (liveNeighbors === 3);
            break matchResult3;
          }
    ...
    while (true) {
      ...
      while (true) {
        var arg1$10 = i$7;
        var row$1 = table.rows[arg1$9];
        var cell$1 = row$1.cells[arg1$10];
        var checkbox$2 = cell$1.firstChild;
        checkbox$2.checked = $n($n(nextState).get(arg1$9)).get(arg1$10);
        if ((i$7 === 59)) {
          break;
        }
        i$7 = ((1 + i$7) | 0);
...
var $n_Lapp_Main$package$;
function $m_Lapp_Main$package$() {
  if ((!$n_Lapp_Main$package$)) {
    $n_Lapp_Main$package$ = new $c_Lapp_Main$package$();
  }
  return $n_Lapp_Main$package$;
}
/** @constructor */
